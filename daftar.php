  ...
  <div class="register-box">
    <div class="card card-outline card-primary">
      <div class="card-header text-center">
        <a href="#" class="h3">Daftar Akun</a>
      </div>
      <div class="card-body">
        <p class="login-box-msg"><b>Aplikasi Pengaduan Masyarakat</b></p>
        ...
        <form action="simpan_daftar.php" method="post">
          ...
          <div class="row">
            <div class="col-8">
             <small><a href="index.php" class="text-center"><u>sudah punya akun</u></a></small>
           </div>
           <!-- /.col -->
           <div class="col-4">
