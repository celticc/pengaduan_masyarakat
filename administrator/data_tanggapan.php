                  ...
                  <div class="card-body">
                    <table class="table table-bordered">
                      ...
                      <tbody style="text-align: center;">
                        ...
                        $sql=$koneksi->query("SELECT * FROM pengaduan INNER JOIN tanggapan ON pengaduan.id_pengaduan = tanggapan.id_pengaduan INNER JOIN petugas ON petugas.id_petugas = tanggapan.id_petugas ");
                        ...
                        foreach ($sql as $pengaduan) {?>
                          <tr>
                           ...
                           <th><?php echo $pengaduan['nama_petugas'] ?></th>
                           <td>
                            <?php if ($pengaduan['status']=='selesai'): ?>
                              <span class="badge bg-primary">selesai</span>
                               <?php elseif($pengaduan['level']!=='admin'): ?>
                                <span class="badge bg-primary">Sudah Ditanggappi</span>
                              <?php else: ?>
